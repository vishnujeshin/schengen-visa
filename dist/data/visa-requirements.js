...
exports.getAllVisaTypes = exports.getVisaRequirements = exports.VISA_REQUIREMENTS = void 0;
/**
...
const getVisaRequirements = (countryId, visaType = 'tourist') => {
    return exports.VISA_REQUIREMENTS.find(v => v.country === countryId.toLowerCase() && v.visaType === visaType);
};
exports.getVisaRequirements = getVisaRequirements;
const getAllVisaTypes = (countryId) => {
    return exports.VISA_REQUIREMENTS.filter(v => v.country === countryId.toLowerCase());
};
exports.getAllVisaTypes = getAllVisaTypes;
