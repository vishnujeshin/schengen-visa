...
const getDocumentChecklist = (countryId, visaType = 'tourist') => {
    return exports.DOCUMENT_CHECKLISTS.find(d => d.country === countryId.toLowerCase() && d.visaType === visaType);
};
