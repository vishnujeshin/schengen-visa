...
exports.getContactInfo = exports.CONTACT_INFO = void 0;
/**
...
const getContactInfo = (countryId, city) => {
    const contacts = exports.CONTACT_INFO.filter(c => c.country === countryId.toLowerCase());
    if (city) {
